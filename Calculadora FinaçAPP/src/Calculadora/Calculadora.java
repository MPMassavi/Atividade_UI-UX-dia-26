...
public class Calculadora {
	 ...
	 * @param a primeiro operando
	 * @param b segundo operando
	 * @if verifica se o {@code b} é igual a 0, se for exibe mensagem de erro
	...
	/**
	 * <p>Executa a operação matemática solícitada com base no operador informado.</p>
	 * 
	 ...
	 * 		<li>"/":Divisão</li>
	 * </ul>
	 * <p>Qualquer resultado inválido resulta em exceção.</p>
	 * 
	 * @param a primeiro operando
	 * @param b segundo operando
	 * @param operador símbulo da operação desejada
